...
urlpatterns = [
    ...
    url(r'^(?P<project_id>[0-9]+)/application_detail/(?P<application_id>[0-9]+)/$',
    ...
    url(r'^(?P<project_id>[0-9]+)/create_application/$',
        views.create_application, name='create_application'),
    url(r'^(?P<project_id>[0-9]+)/delete_application/(?P<application_id>[0-9]+)/$',
